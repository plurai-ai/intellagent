...
exchange_delivered_order_items_schema = ExchangeDeliveredOrderItems.get_info()
exchange_delivered_order_items = StructuredTool.from_function(
        func=ExchangeDeliveredOrderItems.invoke,
        name=exchange_delivered_order_items_schema['function']["name"],
        description=exchange_delivered_order_items_schema['function']["description"],
    )