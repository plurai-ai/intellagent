...
update_reservation_flights_schema = UpdateReservationFlights.get_info()
update_reservation_flights = StructuredTool.from_function(
        func=UpdateReservationFlights.invoke,
        name=update_reservation_flights_schema['function']["name"],
        description=update_reservation_flights_schema['function']["description"],
    )